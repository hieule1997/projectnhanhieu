            ...
            <div class="body">
                <div class="bs-container">
                    <div class="edit-content">
                        ...
                        <div class="img">
                            <img src="{{ $model->newsImage }}" style="width: 50%" alt="" id="preImg">
                        ...
                        <div class="head">
                            <h3 class="title">{{ $model->newsTitle }}</h3>
                            <button class="edit__btn edit__title" type="button"><img src="/backend/images/icon_edit.gif" alt=""></button>
                            <div class="edit-text">
                                <input type="text" class="edit__input" name="newsTitle" value="{{ $model->newsTitle }}">
                            </div>
                        </div>
                        <div class="content">
                            <div>
                                <label>Link bài viết</label>
                                <input type="text" name="linkNews" value="{{ $model->linkNews }}">
                            </div> 
                            <div>
                                <label>Link hiển thị bài viết</label>
                                <input type="text" name="linkShow" value="{{ $model->linkShow }}">
                            </div>
                           <div style="margin-bottom: 30px">
                                <label>Thông tin báo chí</label>
                                <!-- <input type="text" name="summary"> -->
                                <textarea name="newsInfor" id="sumaryckeditor">{{ $model->newsInfor }}</textarea>
