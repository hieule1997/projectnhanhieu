...
@section('content')
    ...
    <div class="body">
        ...
        <div class="title-right">
                        <button class="home__btn" type="button"><a href="{{ route('post.create')}}"><span>+</span>Thêm bài viết</a></button>
                    </div>
                </div>
                                            ...
                                            <div class="tool-content">
                                                <ul class="tool-list">
                                                    <li class="tool-list__item">
                                                        <a href="{{ route ('post.edit',$item->id)}}" class="tool-list__link" class="icon__show">
                                                     ...
                                                     @php
                                                                $url_remove = route('post.destroy',$item->id);
