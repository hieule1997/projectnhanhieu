                ...
                <div class="bs-container">
                    <div class="edit-content">
                        ...
                        <div class="head">
                            ...
                            <div class="edit-text">
                                <input type="text" class="edit__input" name="postTitle" value="">
                            </div>
                        </div>
                        <div class="content">
                            <!-- <div>
                           ...
                           <div style="margin-bottom: 30px">
                                ...
                                <input type="text" name="summary" id="sumaryckeditor"></input>

                            </div>
                            <div >
                                Nội dung dự án
                                <textarea name="content" id="contentckeditor"></textarea>
