            ...
            <div class="body">
                <div class="bs-container">
                    <div class="edit-content">
                        ...
                        <div class="img">
                            <img src="{{ $model->projectImage}}" style="width: 50%" alt="" id="preImg">
                        ...
                        <div class="head">
                            <h3 class="title">{{ $model->projectTitle }}</h3>
                            <button class="edit__btn edit__title" type="button"><img src="/backend/images/icon_edit.gif" alt=""></button>
                            <div class="edit-text">
                                <input type="text" class="edit__input" name="projectTitle" value="{{ $model->projectTitle }}">
                            </div>
                        </div>
                        <div class="content">
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="projectInfor" value="{{ $model-> projectInfor}}">
                            </div>
                            <div class="edit-text">
                                Nội dung dự án
                               <textarea class="contentckeditor" name="projectText">{{ $model->projectText }}</textarea>
                        ...
                        <div class="bs-col md-62-15">
                            <div class="img-edit">
                                <div class="popup-slide">
                                    <div class="item">
                                        <div class="img">
                                            <img src="{{ $model->projectImage }}" style="width: 50%" alt="" id="showImg">
                                        </div>
                                    </div>
